...
#include "EditorModeTestEditorMode.generated.h"
 ...
 */
UCLASS()
class UEditorModeTestEditorMode : public UEdMode
{
	GENERATED_BODY()

public:
	const static FEditorModeID EM_EditorModeTestEditorModeId;

	static FString SimpleToolName;
	static FString InteractiveToolName;

	UEditorModeTestEditorMode();
	virtual ~UEditorModeTestEditorMode();
