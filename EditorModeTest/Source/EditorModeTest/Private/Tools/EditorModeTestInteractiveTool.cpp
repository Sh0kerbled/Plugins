...
#include "EditorModeTestInteractiveTool.h"
...
#define LOCTEXT_NAMESPACE "UEditorModeTestInteractiveTool"

/*
 * ToolBuilder
 */

UInteractiveTool* UEditorModeTestInteractiveToolBuilder::BuildTool(const FToolBuilderState & SceneState) const
{
	UEditorModeTestInteractiveTool* NewTool = NewObject<UEditorModeTestInteractiveTool>(SceneState.ToolManager);
...
void UEditorModeTestInteractiveTool::SetWorld(UWorld* World)
{
	check(World);
...
void UEditorModeTestInteractiveTool::Setup()
{
	...
	Properties = NewObject<UEditorModeTestInteractiveToolProperties>(this, "Measurement");
...
void UEditorModeTestInteractiveTool::OnUpdateModifierState(int ModifierID, bool bIsOn)
{
...
FInputRayHit UEditorModeTestInteractiveTool::CanBeginClickDragSequence(const FInputDeviceRay& PressPos)
{
...
void UEditorModeTestInteractiveTool::OnClickPress(const FInputDeviceRay& PressPos)
{
...
void UEditorModeTestInteractiveTool::OnClickDrag(const FInputDeviceRay& DragPos)
{
	UpdatePosition(DragPos.WorldRay);
}


FInputRayHit UEditorModeTestInteractiveTool::FindRayHit(const FRay& WorldRay, FVector& HitPos)
{
...
void UEditorModeTestInteractiveTool::UpdatePosition(const FRay& WorldRay)
{
...
void UEditorModeTestInteractiveTool::UpdateDistance()
{
	Properties->Distance = FVector::Distance(Properties->StartPoint, Properties->EndPoint);
}


void UEditorModeTestInteractiveTool::OnPropertyModified(UObject* PropertySet, FProperty* Property)
{
...
void UEditorModeTestInteractiveTool::Render(IToolsContextRenderAPI* RenderAPI)
{
