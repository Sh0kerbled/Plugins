...
#include "EditorModeTestSimpleTool.h"
...
#define LOCTEXT_NAMESPACE "EditorModeTestSimpleTool"

/*
 * ToolBuilder implementation
 */

UInteractiveTool* UEditorModeTestSimpleToolBuilder::BuildTool(const FToolBuilderState& SceneState) const
{
	UEditorModeTestSimpleTool* NewTool = NewObject<UEditorModeTestSimpleTool>(SceneState.ToolManager);
...
void UEditorModeTestSimpleTool::SetWorld(UWorld* World)
{
	this->TargetWorld = World;
}


void UEditorModeTestSimpleTool::Setup()
{
	USingleClickTool::Setup();

	Properties = NewObject<UEditorModeTestSimpleToolProperties>(this);
	AddToolPropertySource(Properties);
}


void UEditorModeTestSimpleTool::OnClicked(const FInputDeviceRay& ClickPos)
{
