...
#include "EditorModeTestInteractiveTool.generated.h"
 ...
 */
UCLASS()
class EDITORMODETEST_API UEditorModeTestInteractiveToolBuilder : public UInteractiveToolBuilder
{
	GENERATED_BODY()
 ...
 */
UCLASS(Transient)
class EDITORMODETEST_API UEditorModeTestInteractiveToolProperties : public UInteractiveToolPropertySet
{
	GENERATED_BODY()

public:
	UEditorModeTestInteractiveToolProperties();
 ...
 */
UCLASS()
class EDITORMODETEST_API UEditorModeTestInteractiveTool : public UInteractiveTool, public IClickDragBehaviorTarget
{
	GENERATED_BODY()
...
protected:
	...
	UPROPERTY()
	TObjectPtr<UEditorModeTestInteractiveToolProperties> Properties;
